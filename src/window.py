...
class Cell():
    ...
    def draw(self, p1, p2):
        ...
        if self.has_right_wall:
            self._win.draw_line(Line(Point(self._x1, self._y2), Point(self._x2, self.y2)))
        if self.has_top_wall:
            self._win.draw_line(Line(Point(self._x2, self._y1), Point(self._x2, self.y2)))
        if self.has_bottom_wall:
            self._win.draw_line(Line(Point(self._x1, self._y1), Point(self._x1, self.y2)))